...
public class Speedometer extends View {
    ...
    // Drawing colors
    private int LOW_COLOR = Color.argb(255, 128, 255, 0);    //green
    private int MID_COLOR = Color.argb(255, 255, 128, 0);    //orange
    private int HIGH_COLOR = Color.argb(255, 255, 0, 0);    //red
    private double LOW_MAX = 50;
    private double MID_MAX = 70;
    ...
    public Speedometer(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            LOW_COLOR = a.getColor(R.styleable.Speedometer_lowColor, LOW_COLOR);
            MID_COLOR = a.getColor(R.styleable.Speedometer_midColor, MID_COLOR);
            HIGH_COLOR = a.getColor(R.styleable.Speedometer_highColor, HIGH_COLOR);
            LOW_MAX = a.getFloat(R.styleable.Speedometer_lowMax, 0);
            MID_MAX = a.getFloat(R.styleable.Speedometer_midMax, 0);
    ...
    public void setCurrentSpeed(float mCurrentSpeed) {
        ...
        if (mCurrentSpeed >= 0 && mCurrentSpeed < LOW_MAX) {
            onMarkPaint.setColor(LOW_COLOR);
            onMarkPaint.setShadowLayer(5f, 0f, 0f, LOW_COLOR);
        } else if (mCurrentSpeed < MID_MAX) {
...
//		Log.d(TAG, "Height spec: " + MeasureSpec.toString(heightMeasureSpec));
    ...
    private void drawLegend(Canvas canvas) {
        ...
        double increments = this.mMaxSpeed / 5.2;
